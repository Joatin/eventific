import { InjectSettings, IStore, Logger, Store } from '@eventific/core';
import { assert, string, func } from 'joi';
...
var MongoStore = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, promiseRetry({
                                ...
                                return MongoClient.connect(_this.url)
                                    .catch(function (err) {
    ...
    MongoStore.prototype.listenForEvents$ = function (aggregateName) {
        var _this = this;
        return Observable.create(function (observer) { return __awaiter$1(_this, void 0, void 0, function () {
            var _this = this;
    ...
    MongoStore.prototype.onEvent = function (aggregateName, eventName, callback) {
        var _this = this;
        assert(aggregateName, string(), 'Aggregate name has to be a string and cannot be empty');
        assert(callback, func(), 'callback must be a function');
    ...
    MongoStore = __decorate([
        ...
        __param(0, InjectSettings()),
        __metadata("design:paramtypes", [Object, Logger])
    ], MongoStore);
    return MongoStore;
}(IStore));

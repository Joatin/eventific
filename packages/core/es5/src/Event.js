 ...
 * @since 1.0.0
 */
var IEventHandler = /** @class */ (function () {
    ...
    return function (Class) {
        return _a = /** @class */ (function (_super) {
                ...
                function class_1() {
                    ...
                    _this._logger = args[0].get(Logger_1.Logger);
                    return _this;
                }
                class_1._InstantiateEventHandler = function (parentInjector) {
                    var injector = parentInjector.newChildInjector();
                    return new this(injector);
                };
                class_1.prototype._validateAndHandle = function (event, state) {
                    return __awaiter(this, void 0, void 0, function () {
                        var schema;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    schema = EventMessage_1.eventMessageSchema;
                                    if (options.schema) {
                                    ...
                                    if (!this.handle) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.handle(event, state)];

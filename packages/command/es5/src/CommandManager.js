    ...
    return function (Class) {
        return _a = /** @class */ (function (_super) {
                ...
                function class_1() {
                    ...
                    _this._logger = _this._injector.get(core_1.Logger);
                    return _this;
                }
                            ...
                            switch (_b.label) {
                                ...
                                case 5:
                                    ...
                                    if (transport.onCommand) {
                                        transport.onCommand(function (cmd) { return __awaiter(_this, void 0, void 0, function () {
                ...
                class_1.prototype._handleCommand = function (commandMessage) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this._aggregate.handleCommand(commandMessage)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }

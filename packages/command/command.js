...
var commandManagerOptionsSchema = Joi.object().keys({
    aggregate: Joi.func().unknown().keys({
    ...
    store: Joi.func().unknown().keys({
        _CreateStore: Joi.func().required()
    }).required(),
    transports: Joi.array().min(1).items(Joi.func().unknown().keys({
    ...
    return function (Class) {
        return _a = /** @class */ (function (_super) {
                ...
                class_1._Instantiate = function (parentInjector) {
                    ...
                    injector.set({ provide: core.Logger, useConstant: new core.InternalLogger(chalk.green(pascalCase('CommandManager'))) });
                    return new this({

...
fn it_should_send_message() {
    ...
    rt.block_on(sender.send(Uuid::parse_str("7b32824b-b8a8-4bf1-bda5-e4b0b19f50b2").unwrap())).unwrap()
}
...
fn it_should_fail_on_invalid_endpoint() {
    ...
    rt.block_on(sender.send(Uuid::parse_str("7b32824b-b8a8-4bf1-bda5-e4b0b19f50b2").unwrap())).unwrap_err();
}
